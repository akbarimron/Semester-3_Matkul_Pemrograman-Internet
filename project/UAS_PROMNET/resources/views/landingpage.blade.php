                    ...
                    <div class="dropdown ms-5">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">
                                <form method="GET" action="{{ route('dashboard') }}" class="dropdown-item p-0">
                                    @csrf
...
<main>
    ...
    <section id="about" class="py-5 bg-white" data-aos="fade-up">
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('storage/img/dummy.jpg') }}" alt="Fasilitas" class="img-fluid rounded-3 shadow-custom">
                </div>
            </div>
        </div>
    </section>
    <section id="pricing" class="py-5 gradient-red text-white" data-aos="fade-up">
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <img src="{{ asset('storage/img/dummy.jpg') }}" alt="Pricing" class="img-fluid rounded-3 shadow-custom">
                </div>
    ...
    <section id="trainer" class="py-5 bg-secondary-custom text-white" data-aos="fade-up">
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('storage/img/dummy.jpg') }}" alt="Trainer" class="img-fluid rounded-3 shadow-custom">
                </div>
            </div>
        </div>
    </section>
